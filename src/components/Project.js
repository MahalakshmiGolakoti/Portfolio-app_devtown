...
export default function Project() {
  const projects = [
    {
      id: 1,
      title: "Face Recognition Attendance Based System",
      description:
        "A Flask app that marks the attendance of the students by Face Recognition",
      link: "https://github.com/MahalakshmiGolakoti/FRS-attendance-system",
    ...
    },
    {
      ...
      link: "https://github.com/MahalakshmiGolakoti/food_ordering",
      technologies: ["Django", "Python", "HTML"],
    },
    {
      id: 3,
      title: "Portfolio Website",
      description: "A modern portfolio website built with HTML and CSS.",
      link: "https://example.com",
      technologies: ["HTML", "CSS", "Responsive Design"],
    },
    {
      id: 4,
      title: "Pickpocket detection System",
      description: "A pickpocket detection with accurate results",
      link: "https://example.com",
      technologies: ["Tkinter", "Machine Learning", "Python", "Plotly"],
    },
  ];
