      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center space-y-8 mb-16">
          <h1 className="text-5xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-teal-500 bg-clip-text text-transparent">
            Hi, I'm Mahalakshmi Golakoti
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            I'm a Computer Science enthusiast who loves coding, designing, and learning new technologies.I'm passionate about creating innovative and meaningful projects!
            I'm excited to turn my passion into real-world solutions!
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              I started my journey in web development in college days.My expertise spans across the
